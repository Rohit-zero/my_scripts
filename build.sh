...
git clone --depth=1 https://github.com/Rohit-zero/AnyKernel3.git
echo "Done"
...
export ARCH=arm64
export KBUILD_BUILD_HOST=Xenon_xe
export KBUILD_BUILD_USER="Rohit39"
# sticker plox
function sticker() {
...
function zipping() {
    cd AnyKernel || exit 1
    zip -r9 Xenon_xe_V1.1-${TANGGAL}.zip *
    cd ..
}
sticker
sendinfo
